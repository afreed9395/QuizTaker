...
SECRET_KEY = 'django-insecure-n)9ox^qv5$&+h_@=85qjs^q&zzf@$n9yqaoqk525dsc7c)%e*5'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # For example, if your React app runs here
]
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=200),   # Adjust as needed
